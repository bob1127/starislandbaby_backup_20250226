...
const ShiftingCountdown = () => {
  return (
    <div className=" p-4">
      <div className="mx-auto flex w-[80%] xl:max-w-5xl items-center bg-white">
...
const CountdownItem = ({ unit, text }) => {
  ...
  return (
    <div className="flex  h-24 xl:h-36 w-1/4 flex-col items-center justify-center gap-3 border-r-[1px] border-slate-200 font-mono md:h-36 md:gap-2">
